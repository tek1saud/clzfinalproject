...
const ShopUpdateProduct = () => {
  ...
  const { success,productDetails, error } = useSelector((state) => state.products);
  ...
  useEffect(() => {
    if (productDetails) {
      ...
      setImages(productDetails.images.map(img => img.url));
    }
  }, [productDetails]);
  ...
  return (
    ...
    <div className="w-[90%] 800px:w-[50%] mx-auto mt-12 bg-white  shadow h-[80vh] rounded-[4px] p-3 overflow-y-scroll">
